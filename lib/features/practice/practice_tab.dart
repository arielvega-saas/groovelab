          ...
          actions: [
            ...
            TextButton(
              ...
              child: Text(tr(ref.read(langProvider), 'save'),
                style: AppFonts.outfit(color: AppColors.accent, fontWeight: FontWeight.w700)),
            ),
          ],
        ),
      ),
                ...
                Expanded(child: Column(
                  ...
                  children: [
                    Text(routine['name'] as String? ?? 'Routine',
                      style: AppFonts.outfit(fontSize: 13, fontWeight: FontWeight.w600, color: AppColors.textPrimary)),
            ...
            if (reached)
              Container(
                ...
                child: Text(tr(ref.read(langProvider), 'reached'),
                  style: AppFonts.outfit(fontSize: 11, fontWeight: FontWeight.w700, color: AppColors.accent2)),
              )
            else
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(desc, style: AppFonts.outfit(fontSize: 11, color: AppColors.textMuted, height: 1.3)),
                              ],
                            ),
                          ),
