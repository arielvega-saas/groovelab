          ...
          Row(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(tr(lang, 'settingsTitle').toUpperCase(), style: AppFonts.outfit(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(l['label']!, style: AppFonts.outfit(
      ...
      child: Row(
        children: [
          ...
          Expanded(child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(label, style: AppFonts.outfit(fontSize: 14, fontWeight: FontWeight.w600, color: AppColors.textPrimary)),
              if (subtitle != null)
                Text(subtitle, style: AppFonts.outfit(fontSize: 12, color: AppColors.textMuted)),
            ],
          )),
              ...
              children: [
                Container(
                  ...
                  child: Text(tr(lang, 'proBadge'),
                    style: AppFonts.outfit(fontSize: 11, fontWeight: FontWeight.w700, color: Colors.white)),
                ),
                const SizedBox(width: 8),
                Text(tr(lang, 'proActive'),
                  style: AppFonts.outfit(fontSize: 13, fontWeight: FontWeight.w600, color: AppColors.accent)),
              ],
            ),
      ...
      child: _panel(tr(lang, 'upgradeToPro'), Column(
        ...
        children: [
          ...
          Text(tr(lang, 'proFeatures'),
            style: AppFonts.outfit(fontSize: 11, color: AppColors.textMuted, height: 1.5)),
          ...
          if (rcState.errorMessage != null) ...[
            ...
            Text(rcState.errorMessage!,
              style: AppFonts.outfit(fontSize: 11, color: Colors.redAccent)),
          ],
          ...
          GestureDetector(
            ...
            child: Text(tr(lang, 'restorePurchase'),
              style: AppFonts.outfit(fontSize: 12, color: AppColors.accent,
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Text(price, style: AppFonts.outfit(
