        ...
        child: ClipRRect(
          ...
          child: Stack(
            children: [
                ...
                child: Container(
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [
                        Colors.white.withValues(alpha: _pressed ? 0.02 : 0.08),
                        c.withValues(alpha: _pressed ? 0.01 : 0.04),
              ...
              Positioned(
                bottom: 0, left: 8, right: 8, height: 2,
                child: Container(
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [
                        Colors.transparent,
                        c.withValues(alpha: _pressed ? 0.20 : 0.12),
                        Colors.transparent,
                      ],
                    ),
              ...
              // Content: icon + name + subtitle + status badge
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 6),
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    // Icon container with metallic ring and radial glow
                    Container(
                      width: 44,
                      height: 44,
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color: c.withValues(alpha: m.isLive ? 0.55 : 0.30),
                          width: 1.2,
                        ),
                        boxShadow: [
                          BoxShadow(
                            color: c.withValues(alpha: m.isLive ? 0.40 : 0.22),
                            blurRadius: m.isLive ? 16 : 10,
                            spreadRadius: -3,
                          ),
                          BoxShadow(
                      ...
                      child: Icon(m.icon, color: c, size: 24),
                    ),
                    const SizedBox(height: 6),
                    // Module name
                    Text(
                    ...
                    if (m.subtitle != null) ...[
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: m.isLive
                              ? Border.all(color: c.withValues(alpha: 0.30), width: 0.5)
                              : null,
                        ),
                        child: Text(
                          m.subtitle!,
                          style: AppFonts.outfit(
                            fontSize: 8,
                            fontWeight: FontWeight.w600,
                            color: m.isLive ? c.withValues(alpha: 0.95) : AppColors.textMuted,
                            letterSpacing: 0.3,
                          ),
                          textAlign: TextAlign.center,
                          maxLines: 1,
