        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: playing ? AppColors.accent.withValues(alpha: 0.40) : AppColors.border,
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(8),
                      border: Border.all(
                        color: playing ? AppColors.accent.withValues(alpha: 0.30) : AppColors.border,
                      ),
                    ),
                    child: Column(
                      ...
                      children: [
                        Text('$bpm', style: playing
                            ? AppTheme.lcdStyle(size: 18, weight: FontWeight.w800, color: AppColors.accent, glow: true, glowAlpha: 0.4)
                            : AppTheme.monoStyle(size: 18, weight: FontWeight.w800, color: AppColors.textPrimary)),
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: ['kick', 'snare', 'hihat', 'ride'].map((inst) {
                  ...
                  final isTrackActive = playing && drumStep >= 0 && drumStep < row.length && row[drumStep] == 1;
                  return Row(
                    children: [
                      // Track header with LED dot + color bar + label
                      SizedBox(
                        width: 38,
                        child: Row(
                          children: [
                            // LED dot that lights on beat
                            Container(
                              width: 5, height: 5,
                              margin: const EdgeInsets.only(right: 2),
                              decoration: BoxDecoration(
                                shape: BoxShape.circle,
                                color: isTrackActive ? trackColor : trackColor.withValues(alpha: 0.15),
                                boxShadow: isTrackActive
                                    ? [BoxShadow(color: trackColor.withValues(alpha: 0.7), blurRadius: 6)]
                                    : null,
                              ),
                            ),
                            Container(
                            ...
                            Expanded(child: Text(
                              ...
                              style: AppTheme.monoStyle(
                                size: 9, color: isTrackActive ? trackColor : trackColor.withValues(alpha: 0.85),
          ...
          return AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              gradient: LinearGradient(
                ...
                colors: isLit
                    ? [
                        Color.lerp(c, const Color(0xFF1A1A1A), 0.25)!,
                        Color.lerp(c, const Color(0xFF0E0E0E), 0.45)!,
                      ]
                    : [
              ...
              border: Border(
                top: BorderSide(
                  color: isLit ? c.withValues(alpha: 0.65) : const Color(0xFF2E2E2E),
                  width: 1,
                ),
                left: BorderSide(
                  color: isLit ? c.withValues(alpha: 0.40) : const Color(0xFF282828),
                  width: 1,
                ),
              ...
              boxShadow: isLit
                  ? [
                      BoxShadow(
                        color: c.withValues(alpha: 0.55 + hitVal * 0.3),
                        blurRadius: 14 + hitVal * 10,
                        spreadRadius: -2,
                      ),
                      BoxShadow(
                ...
                Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        shape: BoxShape.circle,
                        color: isLit ? c : c.withValues(alpha: 0.18),
                        boxShadow: isLit ? [
                    ...
                    Icon(widget.icon, size: 14,
                      color: isLit ? Colors.white.withValues(alpha: 0.95) : c.withValues(alpha: 0.5)),
                    const SizedBox(width: 4),
                    // Label
                    Flexible(
                      child: Text(
