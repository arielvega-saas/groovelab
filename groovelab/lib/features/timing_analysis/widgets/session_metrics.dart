...
class SessionMetricsCard extends StatelessWidget {
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Text('SESSION METRICS', style: AppFonts.outfit(
  ...
  Widget _metricColumn({required String value, required String label, String? subtitle, Color? subtitleColor}) {
    return Column(
      children: [
        ...
        Text(label, style: AppFonts.outfit(fontSize: 11, color: AppColors.textMuted)),
        if (subtitle != null) ...[
          ...
          Container(
            ...
            child: Text(subtitle, style: AppFonts.outfit(
  ...
  Widget _qualityBar() {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('NOTE QUALITY', style: AppFonts.outfit(
