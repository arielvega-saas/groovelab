          ...
          if (widget.isLoading)
            Column(
              children: [
                ...
                Text(
                  widget.lang == 'es' ? 'Cargando archivo...'
                      : widget.lang == 'pt' ? 'Carregando arquivo...'
                      : 'Loading audio...',
                  style: AppFonts.outfit(
                    fontSize: 12,
                ...
                Text(
                  widget.lang == 'es' ? 'Esto puede tardar unos segundos'
                      : widget.lang == 'pt' ? 'Isso pode levar alguns segundos'
