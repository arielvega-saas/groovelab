...
final class SongLabEngine {
    ...
    func play() {
        ...
        engine.connect(player, to: varipitch, format: format)
        ...
        let startFrame = AVAudioFramePosition(seekFrame)
        let remainingFrames = AVAudioFrameCount(Int64(totalFrames) - startFrame)
