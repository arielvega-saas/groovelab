...
class _DrumsTabState extends ConsumerState<DrumsTab> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('DRUM STYLE', style: GoogleFonts.outfit(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('MIXER', style: GoogleFonts.outfit(
                  fontSize: 11, fontWeight: FontWeight.w700,
                  color: AppColors.textMuted, letterSpacing: 2,
                )),
                const SizedBox(height: 8),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                Text(tr(lang, 'timeSignature').toUpperCase(), style: GoogleFonts.outfit(
                  fontSize: 11, fontWeight: FontWeight.w700,
                  color: AppColors.textMuted, letterSpacing: 2,
                )),
                const SizedBox(height: 12),
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        ConstrainedBox(
                          ...
                          child: Text(drumStyle, style: GoogleFonts.outfit(
                  ...
                  onTap: () {
                    ...
                    showDialog(
                      ...
                      builder: (ctx) => AlertDialog(
                        backgroundColor: AppColors.bgPanel,
                        title: Text('Set BPM', style: GoogleFonts.outfit(color: AppColors.textPrimary)),
                        content: TextField(
                          controller: ctrl,
                        ...
                        actions: [
                          ...
                          TextButton(
                            ...
                            child: Text('Set', style: GoogleFonts.outfit(color: AppColors.accent)),
                          ),
                        ],
                      ),
                    );
  ...
  Widget _buildHumanFeelPanel(WidgetRef ref) {
    ...
    return Column(
      mainAxisSize: MainAxisSize.min,
      children: [
        Text(tr(lang, 'swingHuman').toUpperCase(), style: GoogleFonts.outfit(
          fontSize: 11, fontWeight: FontWeight.w700,
          color: AppColors.textMuted, letterSpacing: 2,
        )),
        const SizedBox(height: 12),
          ...
          humanFeel == 0
            ...
            : humanFeel <= 15
              ...
              : humanFeel <= 30
                ? tr(lang, 'feelNatural')
                : tr(lang, 'feelLoose'),
          style: GoogleFonts.outfit(fontSize: 11, color: AppColors.textMuted, fontStyle: FontStyle.italic),
        ),
        const SizedBox(height: 8),
      ],
    );
            ...
            child: Padding(
              ...
              child: AppTheme.logicChannelStrip(
                ...
                onVolume: (v) {
                  ...
                  if (playing) ref.read(audioServiceProvider).updateDrumVolumes(updated);
                },
                trackIcon: icon,
                faderHeight: 130,
                stripWidth: 68,
            ...
            child: Padding(
              ...
              child: _DrumPad(
                ...
                onTap: () {
                  ...
                  ref.read(audioServiceProvider).playDrumHit(key);
                },
              ),
            ),
          );
