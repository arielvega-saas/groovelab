        ...
        child: Column(
          ...
          children: [
            ListTile(
              ...
              title: Text(tr(lang, 'editSong'), style: GoogleFonts.outfit(color: AppColors.textPrimary)),
            ...
            ListTile(
              ...
              title: Text(tr(lang, 'duplicateSong'), style: GoogleFonts.outfit(color: AppColors.textPrimary)),
              onTap: () {
                Navigator.pop(ctx);
            ...
            ListTile(
              ...
              title: Text(tr(lang, 'removeSong'), style: GoogleFonts.outfit(color: AppColors.danger)),
              onTap: () {
                Navigator.pop(ctx);
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          TextButton(
            ...
            child: Text(tr(lang, 'cancel'), style: GoogleFonts.outfit(color: AppColors.textMuted)),
          ),
          TextButton(
            onPressed: () {
            ...
            child: Text(tr(lang, 'save'),
              style: GoogleFonts.outfit(color: AppColors.accent2, fontWeight: FontWeight.w700)),
          ),
        ],
      ),
    );
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      labelStyle: GoogleFonts.outfit(color: AppColors.textMuted, fontSize: 11),
                      filled: true, fillColor: AppColors.bgInput,
                      border: OutlineInputBorder(borderRadius: BorderRadius.circular(8), borderSide: BorderSide.none),
                      isDense: true,
                    ),
                  ...
                  Row(
                    children: [
                      Expanded(child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('BPM', style: GoogleFonts.outfit(fontSize: 10, color: AppColors.textMuted)),
                      ...
                      Expanded(child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(tr(lang, 'timeSignature'), style: GoogleFonts.outfit(fontSize: 10, color: AppColors.textMuted)),
                          const SizedBox(height: 4),
                  ...
                  Row(
                    children: [
                      Expanded(child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(tr(lang, 'subdivision'), style: GoogleFonts.outfit(fontSize: 10, color: AppColors.textMuted)),
                          const SizedBox(height: 4),
                          DropdownButton<int>(
                            value: subdivision,
                            dropdownColor: AppColors.bgCard,
                      ...
                      Expanded(child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(tr(lang, 'clickSound'), style: GoogleFonts.outfit(fontSize: 10, color: AppColors.textMuted)),
                          const SizedBox(height: 4),
                          DropdownButton<String>(
                  ...
                  const SizedBox(height: 10),
                  // Swing slider
                  Text('${tr(lang, "swing")}: $swing%', style: GoogleFonts.outfit(fontSize: 10, color: AppColors.textMuted)),
                  Slider(
                  ...
                  // Human Feel slider
                  Text('${tr(lang, "humanFeel")}: $humanFeel%', style: GoogleFonts.outfit(fontSize: 10, color: AppColors.textMuted)),
                  Slider(
                  ...
                  Row(
                    children: [
                      Expanded(child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(tr(lang, 'style'), style: GoogleFonts.outfit(fontSize: 10, color: AppColors.textMuted)),
                          const SizedBox(height: 4),
                          DropdownButton<String>(
                      ...
                      Expanded(child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(tr(lang, 'countIn'), style: GoogleFonts.outfit(fontSize: 10, color: AppColors.textMuted)),
                          const SizedBox(height: 4),
                          DropdownButton<int>(
                            value: countInBars,
                            dropdownColor: AppColors.bgCard,
                  ...
                  if (polyrhythmEnabled) ...[
                    ...
                    Row(
                      children: [
                        Text('Poly: ', style: GoogleFonts.outfit(fontSize: 11, color: AppColors.textMuted)),
                        DropdownButton<int>(
                  ...
                  const SizedBox(height: 10),
                  // Notes
                  Text(tr(lang, 'songNotes'), style: GoogleFonts.outfit(fontSize: 10, color: AppColors.textMuted)),
                  const SizedBox(height: 4),
                  TextField(
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Text(tr(lang, 'saveCurrentSettings'),
                        ...
                        style: GoogleFonts.outfit(fontSize: 11, color: AppColors.accent, fontWeight: FontWeight.w600)),
                    ),
                  ),
                ],
              ),
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            ...
            child: Text('Add', style: GoogleFonts.outfit(color: AppColors.accent, fontWeight: FontWeight.w700)),
          ),
        ],
      ),
    );
          ...
          _panel(tr(lang, 'saveCurrentSettings'), Row(
            children: [
              ...
              ElevatedButton(
                ...
                child: Text(tr(lang, 'save'), style: GoogleFonts.outfit(fontWeight: FontWeight.w700)),
              ),
            ],
          )),
          // Search + filter bar
          _panel(tr(lang, 'savedSongs'), Column(
            children: [
              ...
              if (filtered.isEmpty)
                ...
                ...filtered.map((song) => _librarySongCard(song, library, lang)),
            ],
          )),
        ],
      ),
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text('${songs.length}', style: AppTheme.monoStyle(size: 10, color: AppColors.textMuted)),
                      const SizedBox(width: 8),
                      GestureDetector(
                  ...
                  if (songs.isNotEmpty) ...[
                    const SizedBox(height: 6),
                    ...songs.asMap().entries.map((songEntry) {
                            ...
                            child: Row(
                              children: [
                                  ...
                                  children: [
                                    Text(song['name'] as String? ?? 'Song',
                                      style: GoogleFonts.outfit(fontSize: 12, fontWeight: FontWeight.w500,
                                        color: AppColors.textPrimary)),
                                    Text('${song["bpm"]} BPM \u00b7 ${song["timeSig"]} \u00b7 ${song["clickSound"]}',
                                ...
                                GestureDetector(
                                  ...
                                  child: const Padding(
                                    padding: EdgeInsets.all(4),
                                    child: Icon(Icons.tune, size: 14, color: AppColors.accent2),
                                  ),
                                ),
                              ],
                            ),
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(tr(lang, 'addSong'),
                            style: GoogleFonts.outfit(fontSize: 11, fontWeight: FontWeight.w600, color: AppColors.accent2)),
                        ],
                      ),
                    ),
                  ),
            ...
            child: Row(
              ...
              children: [
                ...
                Text(tr(lang, 'newSetlist'),
                  style: GoogleFonts.outfit(fontSize: 13, fontWeight: FontWeight.w600, color: AppColors.accent2)),
              ],
            ),
          ),
        ),
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(song['name'] as String, style: GoogleFonts.outfit(
                ...
                Wrap(
                  ...
                  children: tags.map((tag) => Container(
                    ...
                    child: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        Text(tag, style: GoogleFonts.outfit(fontSize: 10, color: AppColors.accent)),
                        const SizedBox(width: 4),
                        GestureDetector(
                          onTap: () {
