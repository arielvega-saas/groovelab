...
class _PadsTabState extends ConsumerState<PadsTab> with TickerProviderStateMixin {
  ...
  Future<void> _pickAndLoadSound() async {
    ...
    try {
      ...
      final uint8 = fileData['bytes'] as Uint8List;
      final fileName = fileData['name'] as String;
      final name = fileName.replaceAll(RegExp(r'\.\w+$'), '');
      await _handleFileLoaded(uint8, name);
    } catch (e) {
  ...
  Future<void> _handleFileLoaded(Uint8List uint8, String name) async {
    try {
  ...
  Widget _buildTopBar(String lang) {
    return Container(
      ...
      child: Row(
        children: [
          // Title
          Text('PADS', style: GoogleFonts.outfit(
              ...
              child: AnimatedContainer(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(view.label, style: GoogleFonts.outfit(
...
class _LiveView extends StatelessWidget {
        ...
        child: Row(
          ...
          children: [
            ...
            Text(parent._isLoading ? 'Loading...' : 'Import Sound',
              style: GoogleFonts.outfit(fontSize: 14, fontWeight: FontWeight.w700, color: parent._isLoading ? AppColors.textMuted : Colors.white)),
          ],
        ),
      ),
    );
    ...
    showModalBottomSheet(
      ...
      builder: (_) => Padding(
        ...
        child: Column(
          ...
          children: [
            Text('Key: $key', style: GoogleFonts.outfit(
  ...
  Widget _actionTile(IconData icon, String label, VoidCallback onTap) {
    return ListTile(
      ...
      title: Text(label, style: GoogleFonts.outfit(fontSize: 14, color: AppColors.textPrimary)),
      onTap: onTap,
                ...
                child: AnimatedContainer(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(mode.label, style: GoogleFonts.outfit(
                        fontSize: 10,
                        color: selected ? AppColors.accent : AppColors.textMuted,
    ...
    return Column(
      children: [
        ...
        Container(
          ...
          child: Row(
            children: [
              Text('Songs', style: GoogleFonts.outfit(
          ...
          child: songs.isEmpty
            ? Center(child: Column(
                ...
                children: [
                  ...
                  Text('No songs yet', style: GoogleFonts.outfit(fontSize: 14, color: AppColors.textMuted)),
                  const SizedBox(height: 8),
                  Text('Create songs to save your pad presets', style: GoogleFonts.outfit(fontSize: 12, color: AppColors.textMuted.withValues(alpha: 0.6))),
                ],
              ))
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            const SizedBox(width: 4),
            Text(label, style: GoogleFonts.outfit(fontSize: 11, color: AppColors.accent)),
          ],
        ),
      ),
    );
  ...
  Widget _buildSongCard(PadSong song, int index) {
    ...
    return Container(
      ...
      child: ListTile(
        ...
        title: Text(song.title, style: GoogleFonts.outfit(
          fontSize: 14, fontWeight: FontWeight.w500, color: AppColors.textPrimary,
        )),
        subtitle: Row(
          children: [
            if (song.soundName != null)
              Text(song.soundName!, style: GoogleFonts.outfit(
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  const SizedBox(width: 8),
                  Text('Import Sound', style: GoogleFonts.outfit(
  ...
  Widget _buildFactoryCard(FactoryPadAsset asset) {
    ...
    return Container(
      ...
      child: ListTile(
        ...
        title: Text(asset.name, style: GoogleFonts.outfit(
          fontSize: 14, fontWeight: FontWeight.w500,
          color: isActive ? color : AppColors.textPrimary,
        )),
        subtitle: Row(
          children: [
            Text(asset.category.label, style: GoogleFonts.outfit(
              fontSize: 11, color: AppColors.textMuted,
            )),
            const SizedBox(width: 6),
            Container(
            ...
            : isLoaded
                ? GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Text(isActive ? 'ACTIVE' : 'USE', style: GoogleFonts.outfit(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text('LOAD', style: GoogleFonts.outfit(
                            fontSize: 9, fontWeight: FontWeight.w700,
  ...
  Widget _buildSoundCard(PadSound sound, int index) {
    ...
    return Container(
      ...
      child: ListTile(
        ...
        title: Text(sound.name, style: GoogleFonts.outfit(
          fontSize: 14, fontWeight: FontWeight.w500,
          color: isActive ? AppColors.accent : AppColors.textPrimary,
        )),
        subtitle: Row(
          children: [
            Text(sound.category.label, style: GoogleFonts.outfit(
              fontSize: 11, color: AppColors.textMuted,
            )),
            const SizedBox(width: 8),
  ...
  void _confirmDelete(int index) {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        backgroundColor: AppColors.bgCard,
        title: Text('Delete Sound?', style: GoogleFonts.outfit(color: AppColors.textPrimary)),
        content: Text('This will remove the sound from the pad.', style: GoogleFonts.outfit(color: AppColors.textSecondary)),
        actions: [
          TextButton(
    ...
    return ListView(
      ...
      children: [
        ...
        _buildSection('CROSSFADE', [
          Row(
            children: [
              Text('Time', style: GoogleFonts.outfit(fontSize: 12, color: AppColors.textMuted)),
              const SizedBox(width: 12),
              Expanded(
                child: SliderTheme(
                  data: AppTheme.neumorphicSliderTheme(AppColors.accent, grooveHeight: 5, thumbRadius: 8),
...
class _StageView extends StatelessWidget {
                ...
                child: GestureDetector(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      const SizedBox(width: 6),
                      Text('Lock Screen', style: GoogleFonts.outfit(
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              Text('Double-tap to unlock', style: GoogleFonts.outfit(
  ...
  Widget _buildCurrentState(PadSong? currentSong) {
    if (currentSong != null) {
      return Column(
        children: [
          Text(currentSong.title, style: GoogleFonts.outfit(
    ...
    return Text(activeName, style: GoogleFonts.outfit(
