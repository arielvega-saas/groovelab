        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(tr(lang, 'practiceStatistics').toUpperCase(), style: GoogleFonts.outfit(
          ...
          _panel(tr(lang, 'recentSessions'), history.isEmpty
            ? Text(tr(lang, 'noSessionsYet'),
                style: GoogleFonts.outfit(fontSize: 13, color: AppColors.textMuted, height: 1.5))
            : Column(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(dayLabels[i], style: GoogleFonts.outfit(
