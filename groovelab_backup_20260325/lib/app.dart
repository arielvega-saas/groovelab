        ...
        body: SafeArea(
          ...
          LayoutBuilder(
            builder: (context, constraints) {
              final isWide = constraints.maxWidth > Responsive.phoneMaxWidth;
              return Row(
                children: [
            ...
            children: [
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Row(mainAxisSize: MainAxisSize.min, children: [
                            ...
                            Text('STOP', style: GoogleFonts.outfit(
              ...
              // ── BOTTOM NAV (hidden on wide screens — side nav is used instead) ──
              Builder(builder: (context) {
                final isWideNav = MediaQuery.sizeOf(context).width > Responsive.phoneMaxWidth;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(page['title'] as String, style: GoogleFonts.outfit(
                fontSize: 24, fontWeight: FontWeight.w700, color: AppColors.textPrimary,
              )),
              const SizedBox(height: 12),
              Text(page['desc'] as String, textAlign: TextAlign.center, style: GoogleFonts.outfit(
              ...
              if (!isLast) ...[
                ...
                GestureDetector(
                  ...
                  child: Text(tr(lang, 'onbSkip'), style: GoogleFonts.outfit(
                  ...
                  children: [
                    if (webState == 'recording') ...[
                      ...
                      Text(lang == 'es' ? 'Grabando...' : lang == 'pt' ? 'Gravando...' : 'Recording...',
                        style: GoogleFonts.outfit(fontSize: 13, color: AppColors.danger)),
          ...
          _panel(lang == 'es' ? 'INFORMACIÓN' : 'INFO', Column(
            ...
            children: [
              Text(
                ...
                style: GoogleFonts.outfit(fontSize: 12, color: AppColors.textMuted, height: 1.5),
              ),
            ],
          )),
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            Text('${liveOnsets.length} notes', style: GoogleFonts.outfit(
            ...
            children: [
              ...
              if (currentIdx < songs.length - 1)
                Padding(
                  ...
                  child: Row(
                    children: [
                      Text('${tr(lang, "nextSong")}: ', style: GoogleFonts.outfit(
                        fontSize: 11, color: AppColors.textMuted)),
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(tr(lang, 'prev'), style: GoogleFonts.outfit(fontSize: 8,
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(tr(lang, 'next'), style: GoogleFonts.outfit(fontSize: 8,
