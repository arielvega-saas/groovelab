    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          color: isOn
              ? (isPlayhead ? trackColor : trackColor.withValues(alpha: 0.72))
              : (isPlayhead ? AppColors.bgElevated : AppColors.bgPanel),
          border: Border.all(
            color: isOn
                ? trackColor.withValues(alpha: isPlayhead ? 1 : 0.5)
                : isPlayhead
          ...
          boxShadow: isOn ? [
            BoxShadow(
              color: trackColor.withValues(alpha: isPlayhead ? 0.55 : 0.22),
              blurRadius: isPlayhead ? 12 : 5,
              spreadRadius: isPlayhead ? 1 : 0,
            ),
          ] : (isPlayhead ? [
            BoxShadow(
          ...
          children: [
            ...
            Text('PAN',
                style: GoogleFonts.outfit(
                    ...
                    letterSpacing: 0.8)),
            Text(panStr,
                style: GoogleFonts.jetBrainsMono(fontSize: 8, color: valueColor)),
            if (onPan != null)
              SizedBox(
                height: 20,
                child: SliderTheme(
            ...
            Text('dB',
                style: GoogleFonts.outfit(fontSize: 7, color: labelColor)),
